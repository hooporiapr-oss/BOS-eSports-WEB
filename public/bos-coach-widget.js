...
(function() {
  ...
  async function send() {
    ...
    try {
      ...
      addMessage('system', err.message.includes('fetch') || err.message.includes('Network') ? t.errNetwork : t.errGeneral);
    } finally {
      isLoading = false;
  ...
  langBtn.addEventListener('click', function() {
    try { localStorage.setItem('bos_lang', lang === 'en' ? 'es' : 'en'); } catch(e) {}
